...
class IngredientRegister {
  ...
  IngredientRegister(this.id, this.value);
  ...
  factory IngredientRegister.fromJson(Map<String, dynamic> json) => _$IngredientRegisterFromJson(json);
  ...
  /// `_$UserToJson`.
  Map<String, dynamic> toJson() => _$IngredientRegisterToJson(this);
