...
class AmountRegister {



  AmountRegister(this.id, this.value);
  ...
  factory AmountRegister.fromJson(Map<String, dynamic> json) => _$AmountRegisterFromJson(json);
  ...
  /// `_$UserToJson`.
  Map<String, dynamic> toJson() => _$AmountRegisterToJson(this);
