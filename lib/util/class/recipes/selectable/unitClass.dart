...
class UnitRegister {
  ...
  UnitRegister(this.id, this.value);
  ...
  factory UnitRegister.fromJson(Map<String, dynamic> json) => _$UnitRegisterFromJson(json);
  ...
  /// `_$UserToJson`.
  Map<String, dynamic> toJson() => _$UnitRegisterToJson(this);
