...
part 'recipeCategoryClass.g.dart';
...
class RecipeCategoryRegister {



  RecipeCategoryRegister(this.id, this.value);
  ...
  factory RecipeCategoryRegister.fromJson(Map<String, dynamic> json) => _$RecipeCategoryRegisterFromJson(json);
  ...
  /// `_$UserToJson`.
  Map<String, dynamic> toJson() => _$RecipeCategoryRegisterToJson(this);
