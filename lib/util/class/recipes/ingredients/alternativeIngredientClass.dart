...
part 'alternativeIngredientClass.g.dart';
...
class AlternativeIngredientRegister {



  AlternativeIngredientRegister(this.id, this.name, this.amount, this.unit);
  ...
  factory AlternativeIngredientRegister.fromJson(Map<String, dynamic> json) => _$AlternativeIngredientRegisterFromJson(json);
  ...
  /// `_$UserToJson`.
  Map<String, dynamic> toJson() => _$AlternativeIngredientRegisterToJson(this);
