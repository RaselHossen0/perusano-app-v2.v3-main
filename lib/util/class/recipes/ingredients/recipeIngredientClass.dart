...
import 'alternativeIngredientClass.dart';
...
part 'recipeIngredientClass.g.dart';
...
class RecipeIngredientRegister {



  RecipeIngredientRegister(this.id, this.name, this.amount, this.unit, this.alternatives);
  ...
  factory RecipeIngredientRegister.fromJson(Map<String, dynamic> json) => _$RecipeIngredientRegisterFromJson(json);
  ...
  /// `_$UserToJson`.
  Map<String, dynamic> toJson() => _$RecipeIngredientRegisterToJson(this);
